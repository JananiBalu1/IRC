...
private String applicantMoblie;
...
public String getApplicantMoblie() {
	return applicantMoblie;
}
public void setApplicantMoblie(String applicantMoblie) {
	this.applicantMoblie = applicantMoblie;
}
